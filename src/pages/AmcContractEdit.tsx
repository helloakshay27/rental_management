    ...
    useEffect(() => {
        const fetchResources = async () => {
            try {
                ...
                if (id) {
                    const contractData = await getAuth(`/amc_contracts/${id}.json`);
                    if (contractData) {
                        setFormData({
                            site_id: contractData.site_id?.toString() || contractData.site?.id?.toString() || '',
                            vendor_id: contractData.vendor_id?.toString() || contractData.vendor?.id?.toString() || '',
                            service_type: contractData.service_type || '',
                            contract_value: contractData.contract_value || '',
                            annual_cost: contractData.annual_cost || '',
        ...
        try {
            ...
            const payload = {
                amc_contract: {
                    ...
                    contract_value: parseFloat(formData.contract_value.toString()) || 0,
                    annual_cost: parseFloat(formData.annual_cost.toString()) || 0,
...
export default AmcContractEdit;
