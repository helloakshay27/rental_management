  ...
  return (
    <div className="p-6 space-y-6 bg-white min-h-full">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-[#D5DbDB]">Tenant Dashboard</h1>
          <p className="text-[#D5DbDB]/80 mt-2">Manage your rental properties and landlord relationships</p>
        </div>
