        ...
        <div className="p-8 w-full bg-gray-50 min-h-screen">
            <div className="max-w-full mx-auto space-y-6">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Add New Utility</h1>
                        <p className="text-sm text-gray-500">Register a new utility service for a property</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <Card className="bg-white border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <CardHeader className="border-b border-gray-100 pb-4">
                            ...
                            <CardDescription>Enter the provider and connection information</CardDescription>
                        </CardHeader>
