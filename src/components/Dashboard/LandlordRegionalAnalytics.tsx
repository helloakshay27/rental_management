...
const LandlordRegionalAnalytics = () => {
  ...
  return (
    <Card className="bg-white border border-gray-200">
      <CardHeader>
        <CardTitle className="text-brand-body-1 font-bold text-[#1a1a1a]">Regional Performance Analytics</CardTitle>
      ...
      <CardContent>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
            ...
            <p className="text-brand-body-1 font-bold text-blue-600">Bangalore</p>
          ...
          <div className="bg-green-50 rounded-xl p-6 border border-green-200">
            ...
            <p className="text-brand-body-1 font-bold text-green-600">Mumbai</p>
          ...
          <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
            ...
            <p className="text-brand-body-1 font-bold text-amber-600">Chennai</p>
