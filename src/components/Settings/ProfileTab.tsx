  ...
  return (
    <Card className="bg-white border border-gray-100 shadow-sm p-6">
      <CardHeader className="pt-0 pb-4 px-0">
        ...
        <CardDescription className="text-[13px] text-gray-500">Update your personal and contact information</CardDescription>
      </CardHeader>
      <CardContent className="px-0 space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 p-1.5 bg-white rounded-full shadow-lg border border-gray-100 hover:text-[#C72030] transition-colors"
            >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1.5">JPG, GIF or PNG. 1MB max.</p>
            <input
              type="file"
              ref={fileInputRef}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-9 bg-gray-50 border border-gray-200 text-[13px] text-gray-700 focus:bg-white transition-all"
          ...
          <div className="space-y-1.5">
            <Label className="block text-sm font-medium text-gray-900">Department / Company</Label>
            <Input
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger className="h-9 bg-gray-50 border border-gray-200 text-[13px] text-gray-700">
          ...
          <div className="space-y-1.5 md:col-span-2">
            ...
            <Textarea
              ...
              className="bg-gray-50 border border-gray-200 min-h-[90px] text-[13px] text-gray-700 focus:bg-white transition-all resize-none"
        ...
        <div className="pt-2 flex justify-start">
          <Button
            onClick={handleSave}
            disabled={loading}
            className="fm-button-fix fm-button-brand h-9 px-5 text-[13px]"
          >
